...
export default function StatsPage() {
  return (
    <div className="p-8">
      {/* Header */}
      <div className="mb-8">
        <h1 className="text-3xl font-semibold text-foreground mb-2">WiFi Statistics</h1>
        <p className="text-muted-foreground">Network performance and usage analytics</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">124.5 Mbps</div>
        ...
        <CardContent>
          <div className="text-center py-12">
            ...
            <p className="text-muted-foreground">
              Detailed network statistics and performance charts will be available here.
            </p>
          </div>
        </CardContent>
      </Card>
